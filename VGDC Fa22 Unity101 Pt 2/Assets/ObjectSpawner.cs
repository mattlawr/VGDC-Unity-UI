...
public class ObjectSpawner : MonoBehaviour
{
    ...
    private float totalTime;      // time elapsed since last pipe spawn
    public float spawnerInterval; // amount of time needed for a pipe to spawn
    ...
    void Update()
    {
        ...
        if(totalTime > spawnerInterval) 
        {
            ...
            totalTime = 0; // reset time so it can climb back up to the spawnerinterval
        }
